/**
 * Example code for using mutexes. This program creates 5 threads
 * each of which tries to increment two variables - one shared and one
 * individual. To access the shared variable mutexes are used to guarantee
...
int main(int argc, char **argv) {
	...
	fflush(stdout);
	fprintf(stdout, "----------------------------------\n");
    fprintf(stdout, "Exit Testcases - Thread Mutex\n");
